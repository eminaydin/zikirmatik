...
export const CATEGORIZED_RECOMMENDATIONS: ZikirSection[] = [
  {
    ...
    data: [
      ...
      },
      {
        id: "6",
        arabic:
          "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ وَرِضَا نَفْسِهِ وَزِينَةَ عَرْشِهِ وَمِدَادَ كَلِمَاتِهِ",
        target: 100,
      },
      {
        id: "9",
        arabic: "لَا إِلٰهَ إِلَّا اللَّهُ الْمَلِكُ الْحَقُّ الْمُبِينُ",
        target: 100,
      },
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        id: "2",
        arabic:
          "حَسْبِيَ اللَّهُ لَا إِلٰهَ إِلَّا هُوَ عَلَيْهِ تَوَكَّلْتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ",
        target: 7,
      },
      {
        id: "8",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        id: "11",
        arabic:
          "اللَّهُمَّ صَلِّ صَلاَةً كَامِلَةً وَسَلِّمْ سَلاَمًا تَامًّا عَلَى سَيِّدِنَا مُحَمَّدٍ الَّذِي تَنْحَلُّ بِهِ الْعُقَدُ",
        target: 100,
      },
    ],
  },
