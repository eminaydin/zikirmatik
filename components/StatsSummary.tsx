    ...
    <View>
      ...
      <View style={styles.summaryRow}>
        ...
        >
          ...
          <Text style={styles.summaryValue}>{totalGroupCount}</Text>
          <Text style={styles.summaryLabel}>{t("stats.total_group_zikr")}</Text>
        </View>
        ...
        >
          ...
          <Text style={styles.summaryValue}>{completedGroupGoals}</Text>
          <Text style={styles.summaryLabel}>
            {t("stats.completed_group_zikirs")}
          </Text>
        </View>
      </View>
    </View>
